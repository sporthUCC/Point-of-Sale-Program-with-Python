...
#Print statements were used to generate an organized header for easy reading
#Using the f string and :< :> to maintain orderly and tidy values
def display_catalog():
    print("================================================")
...
#Invoking the "display catalog" function, so that the cashier sees the catalog as soon as the program
display_catalog()
...
def add_to_cart():
    #Creating a for loop that will execute once the value is true and stops when the condition is False
    while True:
      #Found is always false at the start of the loop and reset to false at the start of the loop
      #This helps to track whether product ID entered by the cashier exist.
      found= False
...
def remove_item():
    ...
    while True:
      ...
      if item_to_be_removed.upper()=="E":
         break
      #Error Handling
      #try/except handles cases where an invalid data type is entered
